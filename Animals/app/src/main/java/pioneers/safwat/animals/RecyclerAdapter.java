...
Context context;
    private String[] titles = {"Wild Animals",
            "Pets",
            "Birds"
          };
        ...
        public ViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    switch (position) {
                        case 0:
                            Intent i = new Intent(v.getContext(),pioneers.safwat.animals.CardDemoWilde.class);
                            v.getContext().startActivity(i);
                            break;
                        case 1:
                            Intent i2 = new Intent(v.getContext(),pioneers.safwat.animals.CardDemopitse.class);
                            v.getContext().startActivity(i2);
                            break;
                        case 2:
                            Intent i3 = new Intent(v.getContext(),pioneers.safwat.animals.CardDemobordse.class);
