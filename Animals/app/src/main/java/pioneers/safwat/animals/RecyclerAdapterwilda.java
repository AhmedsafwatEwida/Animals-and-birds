...
public class RecyclerAdapterwilda extends RecyclerView.Adapter<RecyclerAdapterwilda.ViewHolder> {

    private String[] titles = {"أسد",
            "نمر",
            "حمار وحشي",
            "قرد",
            "فيل",
    ...
    private int[] images = {R.drawable.king_of_beasts_lion_2,
            ...
            R.drawable.chimpanzee_branch,
            R.drawable.elephants_trunk,
            R.drawable.gorilla,
            R.drawable.crocodile,
            R.drawable.dirty_rhinoceros};
    private int[] sounds = {R.raw.lion_a,
            R.raw.tiger_a,
            R.raw.zebra_a,
            R.raw.monkey_a,
            R.raw.elephant_a,
